...
class LrsRoutePartBase(metaclass=ABCMeta):
    def __init__(self):
...
class LrsLayerRoutePart(LrsRoutePartBase):
    def __init__(self, polylineGeo):
        super(LrsLayerRoutePart, self).__init__()
