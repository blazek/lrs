...
* **Lines layer:** A layer with lines representing routes. It may contain lines and multi-lines. A single route may be represented by multiple features. Lines do not have to be oriented.
* **Lines route field:** A route id field in lines layer. The field type may be string or integer.
* **Points layer:** A layer with points. It may contain points and multi-points (multi-points make no sense in LRS however).
* **Points route field:** A route id field in points layer. The field type may be string or integer.
* **Measure field:** A measure field in points layer. The field type may be integer or float.
